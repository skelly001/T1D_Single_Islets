# ==============================================================================
# Preprocessing for Non-Diabetic Control Donors (4, 5, 6) - iBAQ Quantification
# ==============================================================================
...
#              for non-diabetic control donors 6178, 6440, and 6539. Calculates
#              protein-level iBAQ values, performs log2 transformation,
#              normalization, outlier removal, and tissue block batch effect
#              correction.
#
# Input: - output/RD1-raw_msnsets/RD1a_1-msnsets_raw.RData
#        - data/uniprot_database_observed_proteins.tsv
#        - FASTA file for protein sequence lengths
# Output: - output/RD2-preprocessing/RD2c_2-control_donors_preprocessing_iBAQ/RD2c_2-msnsets_donor_4_5_6_preprocessed.rds
# ==============================================================================
...
dir.create("output/RD2-preprocessing/RD2c_2-control_donors_preprocessing_iBAQ", showWarnings = F)
...
for (i in names(msnsets)) {
	...
	png(
		filename = glue::glue(
			"output/RD2-preprocessing/RD2c_2-control_donors_preprocessing_iBAQ/RD2c_2-Donor_{donor}_{i}_naplot.png"
		),
		width = 8,
		height = 8,
		units = "in",
	...
	ggsave(
		filename = glue::glue(
			"output/RD2-preprocessing/RD2c_2-control_donors_preprocessing_iBAQ/RD2c_2-Donor_{donor}_{i}_PCA_sample_outliers.png"
		),
		plot = p5,
		width = 4,
		height = 3,
	...
	ggsave(
		filename = glue::glue(
			"output/RD2-preprocessing/RD2c_2-control_donors_preprocessing_iBAQ/RD2c_2-Donor_{donor}_{i}_before_batch_correction.png"
		),
		plot = p1,
		device = "png",
		scale = 1
	...
	ggsave(
		filename = glue::glue(
			"output/RD2-preprocessing/RD2c_2-control_donors_preprocessing_iBAQ/RD2c_2-Donor_{donor}_{i}_before_batch_correction_PCA.png"
		),
		plot = p3,
		width = 4,
		height = 3,
	...
	ggsave(
		filename = glue::glue(
			"output/RD2-preprocessing/RD2c_2-control_donors_preprocessing_iBAQ/RD2c_2-Donor_{donor}_{i}_after_batch_correction.png"
		),
		plot = p2,
		device = "png",
		scale = 1
	...
	ggsave(
		filename = glue::glue(
			"output/RD2-preprocessing/RD2c_2-control_donors_preprocessing_iBAQ/RD2c_2-Donor_{donor}_{i}_after_batch_correction_PCA.png"
		),
		plot = p4,
		width = 4,
		height = 3,
...
saveRDS(
	msnsets,
	file = "output/RD2-preprocessing/RD2c_2-control_donors_preprocessing_iBAQ/RD2c_2-msnsets_donor_4_5_6_preprocessed.rds"
)
