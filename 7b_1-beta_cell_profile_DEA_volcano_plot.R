# ==============================================================================
# Beta Cell Profile Differential Expression Volcano Plots
# ==============================================================================
# Script: 7b_1-beta_cell_profile_DEA_volcano_plot.R
# Description: Visualizes differential expression results from beta cell profile
...
# Output: - output/RD7-beta_cell_profile_analysis/RD7b_1-beta_cell_profile_DEA_volcano_plots.png
# ==============================================================================
...
ggsave(
	filename = "output/RD7-beta_cell_profile_analysis/RD7b_1-beta_cell_profile_DEA_volcano_plots.png",
	plot = p,
	height = 4,
	width = 5.5,
	dpi = 600
