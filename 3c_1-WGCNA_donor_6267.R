# ==============================================================================
# WGCNA Network Analysis - Donor 6267 (Stage 1 T1D)
# ==============================================================================
# Script: 3c_1-WGCNA_donor_6267.R
# Description: Performs Weighted Gene Co-expression Network Analysis (WGCNA) on
#              proteomics data from Stage 1 T1D donor 6267. Constructs protein
...
# Output: - output/RD3-WGCNA/donor_6267/RD3c_1-WGCNA_module_membership.xlsx
#         - output/RD3-WGCNA/donor_6267/RD3c_1-WGCNA_ORA_BP_results.xlsx
#         - QC and visualization plots in output/RD3-WGCNA/donor_6267/
# ==============================================================================
...
fs::dir_create("output/RD3-WGCNA/donor_6267")

if (!file.exists("output/RD3-WGCNA/donor_6267/SoftPower_plot.png")) {
	powers <- 5:30
...
df.final %>%
	select(-all_of(temp)) %>%
	write_xlsx(path = str_glue("output/RD3-WGCNA/donor_6267/RD3c_1-WGCNA_module_membership.xlsx"))
...
ora_results@compareClusterResult %>%
	...
	write_xlsx(path = str_glue("output/RD3-WGCNA/donor_6267/RD3c_1-WGCNA_ORA_BP_results.xlsx"))
...
# Export heatmap
png(
	str_glue("output/RD3-WGCNA/donor_6267/RD3c_1-WGCNA_module_correlation_heatmap.png"),
	width = 2.55,
	height = 3.5,
	units = "in",
	res = 600
