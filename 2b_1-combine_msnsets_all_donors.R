# ==============================================================================
# Combine All Donor MSnSets Without Batch Correction
# ==============================================================================
...
#              and control) into a single MSnSet object. Adds case/control status
#              and class labels based on insulin (INS) and CD3 status. Saves the
#              combined dataset without donor-level batch correction.
#
# Input: - output/RD2-preprocessing/RD2a_1-case_donors_preprocessing/RD2a_1-msnsets_donor_1_2_3_preprocessed.rds
#        - output/RD2-preprocessing/RD2a_2-control_donors_preprocessing/RD2a_2-msnsets_donor_4_5_6_preprocessed.rds
# Output: - output/RD2-preprocessing/RD2b-prepared_data/RD2b_1-msnset_all_donors.rds
# ==============================================================================
...
dir.create("output/RD2-preprocessing/RD2b-prepared_data", showWarnings = F)
...
saveRDS(all2, "output/RD2-preprocessing/RD2b-prepared_data/RD2b_1-msnset_all_donors.rds")
