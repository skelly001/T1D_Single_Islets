# ==============================================================================
# Immune Signature Pathway Enrichment Analysis Using CAMERA-PR
# ==============================================================================
# Script: 5e_1-immune_signature_CAMERA-PR.R
# Description: Performs gene set enrichment analysis using CAMERA-PR (Correlation
...
# Output: - output/RD5-islet_immune_response_signature_analysis/RD5e_1-gene_set_table.csv
...
write.csv(
	x = gene_set_df,
	file = "output/RD5-islet_immune_response_signature_analysis/RD5e_1-gene_set_table.csv",
	quote = FALSE,
	row.names = FALSE
)
...
res %>%
	...
	write.csv(
		file = "output/RD5-islet_immune_response_signature_analysis/RD5e_1-immune_signature_CAMERA-PR_significant_results.csv",
		quote = FALSE,
		row.names = FALSE
	)
...
file <- "data/RD5e_1-immune_signature_CAMERA-PR_significant_results_selected.xlsx"

select_sets <- readxl::read_xlsx(file) %>%
	filter(selected) %>%
	pull(GeneSet)
