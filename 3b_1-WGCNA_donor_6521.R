...
# Output: - output/RD3-WGCNA/donor_6521/RD3b_1-WGCNA_module_membership.xlsx
#         - output/RD3-WGCNA/donor_6521/RD3b_1-WGCNA_ORA_BP_results.xlsx
#         - QC and visualization plots in output/RD3-WGCNA/donor_6521/
# ==============================================================================
...
fs::dir_create("output/RD3-WGCNA/donor_6521")

if (!file.exists("output/RD3-WGCNA/donor_6521/SoftPower_plot.png")) {
	powers <- 5:30
	...
	png(
		str_glue("output/RD3-WGCNA/donor_6521/SoftPower_plot.png"),
		width = 10,
		height = 5,
		units = "in",
		res = 200
...
df.final %>%
	select(-all_of(temp)) %>%
	write_xlsx(path = str_glue("output/RD3-WGCNA/donor_6521/RD3b_1-WGCNA_module_membership.xlsx"))
...
ora_results@compareClusterResult %>%
	...
	write_xlsx(path = str_glue("output/RD3-WGCNA/donor_6521/RD3b_1-WGCNA_ORA_BP_results.xlsx"))
...
# Test module-trait associations
...
# Module size annotation
mod_count <- table(moduleColors)
mods <- names(mod_count)

# Determine text color for readability on module colors
...
# Export heatmap
png(
	str_glue("output/RD3-WGCNA/donor_6521/RD3b_1-WGCNA_module_correlation_heatmap.png"),
	width = 2.5,
	height = 3.5,
	units = "in",
	res = 600
