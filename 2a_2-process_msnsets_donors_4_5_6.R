# ==============================================================================
# Preprocessing for Non-Diabetic Control Donors (4, 5, 6)
# ==============================================================================
# Script: 2a_2-process_msnsets_donors_4_5_6.R
# Description: Preprocesses proteomics data for non-diabetic control donors
#              6178, 6440, and 6539 (donors 4, 5, and 6). Performs protein rollup,
#              log2 transformation, normalization, outlier removal, and tissue
#              block batch effect correction. Generates QC plots including NA
#              plots, PCA, and intensity distributions.
#
# Input: - output/RD1-raw_msnsets/RD1a_1-msnsets_raw.RData
#        - data/uniprot_database_observed_proteins.tsv
# Output: - output/RD2-preprocessing/RD2a_2-control_donors_preprocessing/RD2a_2-msnsets_donor_4_5_6_preprocessed.rds
#         - QC plots in output/RD2-preprocessing/RD2a_2-control_donors_preprocessing/
# ==============================================================================
...
dir.create("output/RD2-preprocessing/RD2a_2-control_donors_preprocessing", showWarnings = F)

# Select non-diabetic control donors (positions 3, 4, 5)
msnsets <- msnsets[c(3, 4, 5)]

donor <- 4

for (i in names(msnsets)) {
	# Remove features with 100% missingness
	msnsets[[i]] <- filter_by_occurrence(msnsets[[i]], 0.00001)
	...
	png(
		filename = glue::glue(
			"output/RD2-preprocessing/RD2a_2-control_donors_preprocessing/RD2a_2-Donor_{donor}_{i}_naplot.png"
		),
		width = 8,
		height = 8,
		units = "in",
	...
	ggsave(
		filename = glue::glue(
			"output/RD2-preprocessing/RD2a_2-control_donors_preprocessing/RD2a_2-Donor_{donor}_{i}_PCA_sample_outliers.png"
		),
		plot = p5,
		width = 4,
		height = 3,
	...
	ggsave(
		filename = glue::glue(
			"output/RD2-preprocessing/RD2a_2-control_donors_preprocessing/RD2a_2-Donor_{donor}_{i}_before_batch_correction.png"
		),
		plot = p1,
		device = "png",
		scale = 1
	...
	ggsave(
		filename = glue::glue(
			"output/RD2-preprocessing/RD2a_2-control_donors_preprocessing/RD2a_2-Donor_{donor}_{i}_before_batch_correction_PCA.png"
		),
		plot = p3,
		width = 4,
		height = 3,
	...
	ggsave(
		filename = glue::glue(
			"output/RD2-preprocessing/RD2a_2-control_donors_preprocessing/RD2a_2-Donor_{donor}_{i}_after_batch_correction.png"
		),
		plot = p2,
		device = "png",
		scale = 1
	...
	ggsave(
		filename = glue::glue(
			"output/RD2-preprocessing/RD2a_2-control_donors_preprocessing/RD2a_2-Donor_{donor}_{i}_after_batch_correction_PCA.png"
		),
		plot = p4,
		width = 4,
		height = 3,
...
saveRDS(
	msnsets,
	file = "output/RD2-preprocessing/RD2a_2-control_donors_preprocessing/RD2a_2-msnsets_donor_4_5_6_preprocessed.rds"
)
